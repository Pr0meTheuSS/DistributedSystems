...
class HttpWorkerConnection final : public WorkerConnection, public userver::components::LoggableComponentBase {
public:
    // `kName` is used as the component name in static config
    static constexpr std::string_view kName = "service-http-worker-connection";

    // Component is valid after construction and is able to accept requests
    HttpWorkerConnection(const userver::components::ComponentConfig&, const userver::components::ComponentContext&);
