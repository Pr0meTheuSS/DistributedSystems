...
class RequestsRepositoryInMemory final : public RequestsRepository, public userver::components::LoggableComponentBase {
public:
    // `kName` is used as the component name in static config
    static constexpr std::string_view kName = "repository-requests-in-memory";

    RequestsRepositoryInMemory(
        const userver::components::ComponentConfig&, const userver::components::ComponentContext&);
